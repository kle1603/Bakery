    ...
    <body>
                ...
                <section class="cart">
                    <div class="container">
                        <div class="cart__inner">
                            ...
                            >
                                <c:set
                                    var="totalAmount"
                                    scope="page"
                                    value="${totalAmount + (item.quantity * item.breadId.price)}"
                                />
                                    ...
                                    <article class="cart__list">
                                        <section class="cart__item">
                                            ...
                                            >
                                                ...
                                                <c:param
                                                    name="breadId"
                                                    value="${item.breadId.breadId}"
                                                />
                                                <c:param
                                                    name="error"
                                                    value="${item.breadId.breadName}"
                                                />
                                            </c:url>
                                            <a
                                                href="${delete}"
                                            ...
                                            <div class="cart__item-image">
                                                <img
                                                    src="${item.breadId.imageUrl}"
                                                    alt=""
                                                    class="cart__image"
                                                />
                                            </div>
                                            <h2 class="cart__item-title">
                                                ${item.breadId.breadName}
                                            </h2>
                                        </section>
                                        <div class="cart__item-content">
                                            ...
                                            <fmt:formatNumber
                                                value="${item.quantity * item.breadId.price}"
                                                pattern="#0.00"
                                                var="formattedTotal"
                                            />
                        ...
                        <div class="cart__footer">
                            ...
                            <a href="${productUrl}" class="cart__footer-right"
        ...
        <c:if test="${empty sessionScope.ITEM_LIST}">
            <main>
                <section class="cart">
                    <div class="container">
                        <h1 class="cart__heading">Enjoy and buy something</h1>
                    </div>
                </section>
            </main>
        </c:if>
