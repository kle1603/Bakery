                    ...
                    <div class="header__inner">
                        ...
                        <div class="navbar">
                            <ul class="navbar__list">
                                ...
                                <li class="navbar__item">
                                    <a href="./pricing.jsp" class="navbar__link"
                                       >Pricing</a
                                    >
                                </li>
                                <li class="navbar__item">
                                    <a href="./contact.jsp" class="navbar__link"
                                       >Contact us</a
                                    >
                                </li>
                                <li class="navbar__item">
                                    <a href="./blog.jsp" class="navbar__link"
                                       >Blog</a
                                    >
                                </li>
                                <li class="navbar__item">
                                    <a href="./about.jsp" class="navbar__link"
                                       >About us</a
                                    >
                                </li>
                            </ul>
                        ...
                        <div class="header-action">
                            <a href="user.jsp" class="header-icon avatar-icon">
                                <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                            ...
                            <a href="${cartItem}" class="header-icon cart-icon">
                                <svg
                                    width="22"
                                    height="24"
                                    viewBox="0 0 22 24"
